...
async def followers(message: Message, state: FSMContext):
    await message.answer("Rasm yoki videoning url manzilini  kiriting")
    await state.finish()
    await Shogirdchalar.Url_like_state.set()

@dp.message_handler(content_types=types.ContentType.TEXT,state=Shogirdchalar.Url_like_state)
async def likes(message: Message, state: FSMContext):
    ...
    if url.startswith("https://www.instagram.com"):
        ...
        await message.answer("Tentak Narmalniy Link tashla")
